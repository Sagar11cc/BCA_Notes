...
# If not subject ID is set
if (!isset($_GET['id'])) {
	header("Location: index.php");
	exit;
}

# Get subject ID from GET request
$id = $_GET['id'];
...
$notes = get_notes_by_semester($conn, $id);
...
$current_subject = get_subject($conn, $id);
...
<head>
	...
	<title><?=$current_subject['name']?></title>
<style>
	body{
...
<body>
	<div class="container" >
		<nav class="navbar ">
		    ...
		    <a class="navbar" href="index.php">Online note Store</a>
	         ...
	         <div class="side_content">        
			        ...
			        <div class="list-group">
				      <?php if ($subjects == 0){
				       ...
				       <a href="#"
				       class="list-group"><h3 class="custom-heading">Subjects</h3></a>
				      ...
				      <?php } } ?>
			            ...
			            <div class="list-group">
				            ...
				            <br>
			            	<a href="#"
				            class="list-group"><h3 class="custom-heading">Semester</h3></a>
				             <?php foreach ($semesters as $semester ) {?>
				             
				             <a href="semester.php?id=<?=$semester['id']?>"
				             class="list-group">
				             <?=$semester['name']?></a>
				             <?php } } ?>
			            </div>
			            ...
			            <div class="list-group">
			        	  <?php if ($teachers == 0){
				            ...
				            <a href="#"
				             class="list-group"><h3 class="custom-heading">Teacher</h3></a>
				                     ...
				                     <?php foreach ($notes as $note) { ?>
				                       <div class="card ">
					                      <img src="uploads/cover/<?=$note['cover']?>"class="card-img-top" width="300" height="300">
                                             ...
                                             class="btn btn-success"><span style="background-color: #F4FA99;">Open</span></a>
